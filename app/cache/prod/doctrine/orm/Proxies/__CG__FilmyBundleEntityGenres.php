 ...
 */
class Genres extends \FilmyBundle\Entity\Genres implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'FilmyBundle\\Entity\\Genres' . "\0" . 'id', '' . "\0" . 'FilmyBundle\\Entity\\Genres' . "\0" . 'genre', '' . "\0" . 'FilmyBundle\\Entity\\Genres' . "\0" . 'idFilm');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Genres $proxy) {
