 ...
 */
class Review extends \FilmyBundle\Entity\Review implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'FilmyBundle\\Entity\\Review' . "\0" . 'id', '' . "\0" . 'FilmyBundle\\Entity\\Review' . "\0" . 'idFilm', '' . "\0" . 'FilmyBundle\\Entity\\Review' . "\0" . 'title', '' . "\0" . 'FilmyBundle\\Entity\\Review' . "\0" . 'text');
        }
