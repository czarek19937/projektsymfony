...
class __TwigTemplate_a0a04e85939f2e91aa32a2e2d064de00bdba4637d82b4065d3852171339bd10b extends Twig_Template
{
    ...
    public function block_header($context, array $blocks = array())
    {
        // line 6
        echo "        <h1>";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["movies"]) ? $context["movies"] : null), "title", array()), "html", null, true);
        echo "</h1>
   ...
   <ul>
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["movies"]) ? $context["movies"] : null), "image", array()), "html", null, true);
        ...
        echo " </a>
                        <br>Opis:";
        // line 23
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["movies"]) ? $context["movies"] : null), "description", array()), "html", null, true);
        echo "
                        <br>Id_filmu:";
        // line 24
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["movies"]) ? $context["movies"] : null), "id", array()), "html", null, true);
        echo "
                        <br>Cena:";
        // line 25
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["movies"]) ? $context["movies"] : null), "price", array()), "html", null, true);
        echo "
                        <br>Aktorzy:
                        ";
        // line 27
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["actors"]) {
            // line 28
            echo "                            ";
            if (($this->getAttribute($context["actors"], "idfilm", array()) == $this->getAttribute((isset($context["movies"]) ? $context["movies"] : null), "id", array()))) {
                // line 29
                echo "                                ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["genre"]) {
            // line 34
            echo "                        ";
            if (($this->getAttribute($context["genre"], "idfilm", array()) == $this->getAttribute((isset($context["movies"]) ? $context["movies"] : null), "id", array()))) {
                // line 35
                echo "                        ";
