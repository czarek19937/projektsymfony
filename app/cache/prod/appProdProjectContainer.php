...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '10.254.94.2', 'port' => 3306, 'dbname' => 's173152', 'user' => 's173152', 'password' => 'DXTmBLUT', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/FilmyBundle/Resources/config/doctrine') => 'FilmyBundle\\Entity'));
        $a->setGlobalBasename('mapping');
        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'FilmyBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('FilmyBundle' => 'FilmyBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2fed904538c1e2ec57b7b01b7197b6d30b7bcae04e6481b70c8deaa2b664a6da');
        return $instance;
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('FilmyBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('FilmyBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('FilmyBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('FilmyBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'FilmyBundle\\Entity\\User');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('s173152');
        $a->setPassword('czarek1993');
        $a->setAuthMode(NULL);
        ...
        $instance->setHost('wizard.uek.krakow.pl');
        $instance->setPort(25);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Student/HelloBundle/Resources/views'), 'StudentHello');
        $instance->addPath(($this->targetDirs[3].'/src/FilmyBundle/Resources/views'), 'Filmy');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'StudentHelloBundle' => 'Student\\HelloBundle\\StudentHelloBundle',
                'FilmyBundle' => 'FilmyBundle\\FilmyBundle',
            ...
            'database_port' => 3306,
            'database_name' => 's173152',
            'database_user' => 's173152',
            'database_password' => 'DXTmBLUT',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'wizard.uek.krakow.pl',
            'mailer_user' => 's173152',
            'mailer_password' => 'czarek1993',
            'locale' => 'pl',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'wizard.uek.krakow.pl',
            'swiftmailer.mailer.default.transport.smtp.username' => 's173152',
            'swiftmailer.mailer.default.transport.smtp.password' => 'czarek1993',
            ...
            'fos_user.model.user.class' => 'FilmyBundle\\Entity\\User',
